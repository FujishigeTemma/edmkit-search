...
def temporal_split(
    ...
    *,
    ...
    return Fold(train_indices, val_indices)
...
def expanding_splits(
    ...
    *,
    ...
    ------
    `ValueError`
        If `n`, `min_train`, or `val_size` are not positive, or `gap` is negative.

    Examples
    --------
    ```python
    folds = expanding_splits(20, min_train=10, val_size=5)
...
def sliding_splits(
    ...
    *,
    ...
    ------
    `ValueError`
        If `n`, `train_size`, or `val_size` are not positive, or `gap` is negative.

    Examples
    --------
    ```python
    folds = sliding_splits(20, train_size=10, val_size=5)
    # fold 0: train=[0..9]   val=[10..14]
